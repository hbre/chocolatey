...
namespace updater.tests
{
    public class GetLatestVersionTest
    {
        ...
        public void GetUrlTest()
        {
            ...
            Assert.Equal(
                "http://downloads.ncrunch.net/NCrunch_Console_3.23.0.10.msi",
                url.ToString()
            );
        }
        ...
        {
            var downloadSite =
                "       <p>Your download should be starting automatically.  If for some reason it doesn't, <a href=\"http://downloads.ncrunch.net/NCrunch_VS2012_3.23.0.10.msi\">try this link instead</a>.</p>"
            ...
            Assert.Equal(
                "http://downloads.ncrunch.net/NCrunch_VS2012_3.23.0.10.msi",
                url.ToString()
            );
        }
